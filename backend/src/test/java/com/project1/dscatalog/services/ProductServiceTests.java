...
public class ProductServiceTests {
    ...
    @Test
    public void updateIdShouldThrowResourceEntityNotFoundExceptionWhenDoesNotIdExists() {
    ...
    @Test
    public void findByIdShouldThrowResourceEntityNotFoundExceptionWhenDoesNotIdExists() {
        Assertions.assertThrows(ResourceEntityNotFoundException.class, () -> {
    ...
    @Test
    public void deleteShouldResourceEntityNotFoundExceptionWhenDoesNotIdExists() {
        Assertions.assertThrows(ResourceEntityNotFoundException.class, () -> {
